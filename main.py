# main.py — BOT pour Railway / Replit (utilise variables d'environnement)
# KEEP-ALIVE + slash commands + /teste (30s) + notifications quotidiennes
...
# ----- CONFIG via ENV VARS -----
TOKEN = os.getenv("***REMOVED***")  # à configurer dans Railway (Variables)
CHANNEL_ID = int(os.getenv("CHANNEL_ID", "1446940514879275131"))
NOTIF_HOUR = int(os.getenv("NOTIF_HOUR", "18"))
NOTIF_MINUTE = int(os.getenv("NOTIF_MINUTE", "0"))
